            ...
            <div class="row seccion_inicio">
                <div class="col-md-6">
                    <div class="message-box">
                        <h4>UTPL 2019</h4>
                        <h2>Los Números, Sus Clasificaciones</h2>
                        <p class="lead">Los números se clasifican en cinco tipos principales: números naturales «N», números enteros «Z», números racionales «Q», números reales «R» (incluyen a los irracionales) y números complejos «C»....</p>

                        <p> </p>

                        <a href="primera.php" data-scroll class="btn btn-light btn-radius btn-brd grd1 effect-1">Saber mas sobre los números</a>
                    </div><!-- end messagebox -->
                </div><!-- end col -->
            ...
            <div class="row seccion_inicio">
                <div class="col-md-6">
                    <div class="message-box">
                        ...
                        <p class="lead">El límite de una función en un punto es obtener el valor al que se va aproximando esa función cuando x tiende a un determinado punto, pero sin llegar a ese punto. Es decir Si f(x) se acerca arbitrariamente a un número L cuando x se aproxima a c, entonces el límite de f(x) cuando x se aproxima a c es L...
                        </p>

                        <p> </p>

                        <a href="tercera.php" data-scroll class="btn btn-light btn-radius btn-brd grd1 effect-1">Saber mas sobre Límites</a>
                    </div><!-- end messagebox -->
                </div><!-- end col -->
                ...
                <div class="col-md-6">
                    <div class="post-media wow fadeIn">
                    <!-- <iframe width="560" height="315" src="https://www.youtube.com/embed/mvj_KLgO_5Q" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen autoplay></iframe> -->
                        <img src="images/lim.gif" alt="" width="300" height="400">
                        <!-- <a href="http://www.youtube.com/watch?v=nrJtHemSPW4" data-rel="prettyPhoto[gal]" class="playbutton"><i class="flaticon-play-button"></i></a> -->
                    </div><!-- end media -->
                </div><!-- end col -->
            </div><!-- end row -->
 ...
 <div class="container">
            ...
            <div class="row seccion_inicio">                
                ...
                <div class="col-md-6">
                    <div class="message-box">
                        <h4>UTPL 2019</h4>
                        <h2>Derivadas Y Sus Propiedades</h2>
                        <p class="lead">En matemáticas, la derivada de una función, es la razón de cambio instantánea con la que cambia el valor de dicha función matemática, según cambie el valor de su variable independiente. La derivada de una función es un concepto local, es decir....</p>

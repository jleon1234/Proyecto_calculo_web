...
<div class="all-title-box">
    <div class="container text-center">
        <h1>Graficar Función<span class="m_1">Esta pequeña app te Ayudara a obtener los valores para poder graficar cualquier función cuadrática</span></h1>
    </div>
</div>
    ...
    <div class="row contenido_funcion">
        ...
        <div class="col-md-4">
            <div class="form-group">
                <label for="">Ingrese la función: </label>
            </div>
            <div class="form-group">
